...
- Editor keyboard hotkeys (when focus is not in an input/textarea/select/contenteditable): `Space` toggles play/pause, `←` seeks back 3 seconds, and `→` seeks forward 3 seconds.
