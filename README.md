...
- The `gl_impossible_corridor` effect raymarches a WebGL2 “impossible corridor” tunnel; it automatically falls back to a Canvas effect if WebGL2 or shader compilation fails.
