...
| `uv_unwrap` | `unwrap`, `uvScale`, `cameraDist`, `rotationSpeed`, `edgeStrength`, `explode` | Faux-3D cube that morphs between solid form and cross-layout UV islands with seam-forward edge rendering. |
