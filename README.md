...
| `water_drops` | `dropCount`, `minRadius`, `maxRadius`, `fallSpeed`, `distortion`, `trail`, `audioReact`, `tint`, `seed` | Simulates droplets on glass with soft highlights, edge refraction rings, and optional downward trails. |
