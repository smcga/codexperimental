...
- Native browser scrollbars are also visible on the timeline viewport (styled thin/cyan) as an always-on fallback, so horizontal/vertical scrolling remains discoverable even when custom bars are visually cropped.
