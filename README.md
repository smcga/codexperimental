...
- The timeline editor layout now uses a cleaner three-pane shell (Scenes sidebar, centre Preview+Timeline workspace, Inspector sidebar) with a single Track 1 timeline lane and selected/current scene clip highlight.
