...
- Scene/layer parameter editing now uses control-aware numeric inputs: bounded params get a slider + numeric spinner with +/- nudge buttons, while unbounded numeric params get touch-friendly spinner controls for faster desktop and mobile tweaking.
