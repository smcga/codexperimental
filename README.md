...
- The `water_reflection` effect mirrors the current scene into the bottom third of the viewport with compressed watery reflections, shimmer bands, and ripple rings; tune `params` like `rippleAmp`, `rippleFreq`, `rippleSpeed`, `shimmer`, `chop`, `tint`, `opacity`, `audioReact`, and `seed`.
...
| `water_reflection` | `rippleAmp`, `rippleFreq`, `rippleSpeed`, `shimmer`, `chop`, `tint`, `opacity`, `audioReact`, `seed` | Mirrors the current scene into the bottom third of the viewport with compressed reflections, shimmer bands, and ripple rings. |
