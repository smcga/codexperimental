...
- The `flyover` effect renders a sky/sea/islands flythrough; tune `params.palette` ("day" | "sunset" | "night"), `params.speed`, `params.fog`, and `params.islandSeed` for different moods.
