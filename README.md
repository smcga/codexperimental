...
| `rainbow_cat` | `speed`, `rainbowLength`, `bounce`, `sparkle`, `trailAlpha`, `catScale`, `starDensity`, `seed` | Synth-night rainbow cat with a bobbing pixel body, glitter stars, and a configurable six-colour trail. |
