...
| `lush_life_dance` | `bpm`, `amplitude`, `bounce`, `trail`, `glow`, `silhouetteScale`, `stageHue`, `accentHue`, `audioReactive` | Concert-pop silhouette choreography loop with hip-led grooves, bold arm hits, and beat-reactive stage glow. |
