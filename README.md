...
- While the demo is running, tapping/clicking the main canvas injects a manual beat pulse so audio-reactive effects thump like a kick hit.
...
- The start overlay also includes a subtle text link to `/human-stuff/index.html` for a non-AI "100% organic hand crafted human version" variant.
- `R` to restart
