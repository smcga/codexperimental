...
| `world_builder` | `gridWidth`, `gridDepth`, `maxHeight`, `voxelSize`, `speed`, `horizon`, `audioReact`, `beatKick`, `seed` | Isometric voxel city blocks emerge from the ground in rhythmic build waves. |
