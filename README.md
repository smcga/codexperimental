...
| `taco_meteor_shower` | `shellCount`, `swirl`, `trail`, `toppingBurst`, `salsaChaos`, `audioReact`, `colorHeat`, `seed` | Luminescent taco shells spiral like meteors, then burst into avocado, cilantro, salsa, and golden shell shards on impact. |
