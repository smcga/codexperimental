...
- The `rain` effect renders layered rain streaks with wind drift and optional splashes; tune `params` like `intensity`, `wind`, `speed`, `streakLength`, `splash`, `hue`, and `seed`.
