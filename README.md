...
| `matrix_rain` | `speed`, `density`, `fontSize`, `trail`, `glow`, `brightness`, `jitter`, `glyphSet`, `seed` | Falling green code columns with glowing heads, configurable trail persistence, and alternate glyph banks for a classic Matrix-style terminal rain. |
