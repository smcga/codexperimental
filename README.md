...
- Preview audio analysis is sampled at a lower rate and loop checks are timer-based (instead of extra per-frame RAF work) to keep mobile effect-generation performance smoother.
