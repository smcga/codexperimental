...
| `tetris_matrix` | `speed`, `level`, `glow`, `contrast`, `ghost`, `seed` | Self-playing falling-block match with all 12 pentominoes, clearer side-panel HUD spacing, safe top-out game-over restarts, and human-like rotate/quick-drop/hesitation choices in tricky spots. |
