...
| `matrix_rain` | `speed`, `density`, `fontSize`, `trail`, `glow`, `brightness`, `jitter`, `glyphSet`, `seed` | Matrix-style falling code rain with smaller default glyphs, smoother continuous descent, and controllable trail persistence/glow. |
