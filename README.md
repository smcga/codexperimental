...
| `heat_haze` | `intensity`, `speed`, `scale`, `drift`, `region`, `centerY`, `height`, `feather`, `shimmer`, `blurHint`, `tint`, `audioReactive`, `beatBoost`, `bassInfluence`, `seed` | Localized refractive hot-air shimmer using strip displacement with upward drift and turbulent micro-jitter. |
