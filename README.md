...
| `liveDomWaveOptics` | `geometryDensity`, `diffraction`, `dispersion`, `causticStrength`, `interference`, `refraction`, `gloss`, `animationSpeed`, `audioReactive`, `seed` | Live-DOM-inspired faux wave-optics pass that layers diffraction tinting, caustic pulses, interference bands, and refractive panel drift. |
