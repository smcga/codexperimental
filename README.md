...
| `ascii_arcade_mashup` | `speed`, `blend`, `density`, `glow`, `scanlines`, `seed` | ASCII mini-scenes inspired by arcade classics (Pong, maze chase, asteroid field, invader wave) that dither-blend into each other. |
| `rotozoom` | `speed` |  |
