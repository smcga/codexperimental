...
- Append `?editor=1` in dev builds to open the Scene + Timeline Editor (or toggle "Editor mode" in the debug overlay). Edits hot-apply to the running demo and persist to localStorage.
