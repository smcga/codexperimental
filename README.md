...
- The effect-idea modal now auto-retries after failures (up to 5 self-improvement retries), shows active attempt counts, and falls back with an apology message when all retries are exhausted.
