...
export type TransitionRendererApi = {
  ...
  drawCheckerboardWipe: (context: TransitionDrawContext) => void;
  drawVenetianBlinds: (context: TransitionDrawContext) => void;
  drawRadialWipe: (context: TransitionDrawContext) => void;
  drawNoiseThreshold: (context: TransitionDrawContext) => void;
  drawPortalZoom: (context: TransitionDrawContext) => void;
  drawWhipPan: (context: TransitionDrawContext) => void;
  drawQuantumSlice: (context: TransitionDrawContext) => void;
  drawChromaticBloom: (context: TransitionDrawContext) => void;
  drawNeuralFeedback: (context: TransitionDrawContext) => void;
  drawMobileDefaultCrossfade: (context: MobileTransitionDrawContext) => void;
  drawMobileWipe: (context: MobileTransitionDrawContext) => void;
  drawMobileSlide: (context: MobileTransitionDrawContext, directionX: number, directionY: number) => void;
  drawMobileIris: (context: MobileTransitionDrawContext) => void;
  drawMobileCheckerboardWipe: (context: MobileTransitionDrawContext) => void;
  drawMobileVenetianBlinds: (context: MobileTransitionDrawContext) => void;
  drawMobileRadialWipe: (context: MobileTransitionDrawContext) => void;
