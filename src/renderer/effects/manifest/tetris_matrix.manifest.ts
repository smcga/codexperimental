...
export const tetris_matrixManifest = defineEffectManifest({
  ...
  docs: {
    ...
    catalogNote: "Self-playing falling-block match with full pentomino sets (all 12 five-cell shapes), a clearer side-panel HUD, safe top-out game-over restarts, chunky monochrome shading, and a dot-matrix handheld screen vibe.",
