...
export const physics_pileManifest = defineEffectManifest({
  ...
  debug: {
    ...
    controls: [
      numberControl("count", "Count", 10, { min: 5, max: 120, step: 1 }),
      numberControl("restitution", "Restitution", 0.95, { min: 0, max: 1, step: 0.01 }),
      numberControl("friction", "Friction", 0.12, { min: 0, max: 1, step: 0.01 }),
      numberControl("gravity", "Gravity", 540, { min: 0, max: 2400, step: 10 }),
      ...
      numberControl("kickRadius", "Kick Radius", 138, { min: 1, max: 1000, step: 1 }),
      numberControl("scatterAngleDeg", "Scatter Angle", 121, { min: 0, max: 180, step: 1 }),
      numberControl("scatterJitter", "Scatter Jitter", 0.7, { min: 0, max: 1, step: 0.01 }),
      numberControl("kickUpBias", "Kick Up Bias", 1, { min: 0, max: 1, step: 0.01 }),
      numberControl("kickTorque", "Kick Torque", 111, { min: 0, max: 360, step: 1 }),
      numberControl("loosenDuration", "Loosen Duration", 1.1, { min: 0, max: 5, step: 0.01 }),
      numberControl("loosenFrictionMult", "Loosen Friction Mult", 0, { min: 0, max: 1, step: 0.01 }),
      ...
      numberControl("sepBiasDeg", "Separation Bias", 17, { min: 0, max: 180, step: 1 }),
      numberControl("seed", "Seed", 7, { min: 0, max: 9999, step: 1 }),
      numberControl("trail", "Trail", 0, { min: 0, max: 1, step: 0.01 }),
      numberControl("shatter", "Shatter", 0.2, { min: 0, max: 1, step: 0.01 }),
