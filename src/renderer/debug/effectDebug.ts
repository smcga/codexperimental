...
const EFFECT_DEBUG_CONFIGS: Record<string, EffectDebugConfig> = {
  ...
  gl_impossible_corridor: {
    ...
    controls: [
      ...
      numberControl("warp", "Warp", 1.15, { min: 0, max: 2, step: 0.05 }),
      numberControl("hueShift", "Hue Shift", 0.12, { min: 0, max: 1, step: 0.01 }),
      numberControl("exposure", "Exposure", 1.15, { min: 0.5, max: 2, step: 0.05 }),
